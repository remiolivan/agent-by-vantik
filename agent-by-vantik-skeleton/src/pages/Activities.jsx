  ...
  return (
    <div className="min-h-screen bg-paper">
      <header className="border-b border-fog/20 px-8 py-5">
        <div className="font-display text-lg font-medium text-nightfall">Activity</div>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-8 py-8">
        <form onSubmit={createActivity} className="flex gap-3 items-start mb-8">
          ...
          />
          <button type="submit" className="bg-nightfall text-white text-sm rounded px-4 py-2">Log</button>
        </form>
        ...
        <div className="space-y-4">
          ...
          {activities.length === 0 && <p className="text-sm text-fog text-center py-8">No activity logged yet.</p>}
        </div>
      </main>
    </div>
  )
